...
def refresh_epaper_fast():
    """
    Refreshes the e-paper display quickly.
    """
    epd.init_fast()
    logging.info("1. Drawing on the image...")
    image = Image.new('1', (epd.height, epd.width), 255)  # 255: clear the frame    
...
def show_webuntis():
    """
    Displays the WebUntis schedule on the e-paper display.
    """
...
def login_to_iserv():
    """
    Logs in to the IServ platform.
    """
    s.login()

def refresh_schedule():
    """
    Refreshes the schedule from WebUntis and updates the timetable.
    """
...
def update_timetable():
    """
    Updates the timetable based on the refreshed schedule.
    """
